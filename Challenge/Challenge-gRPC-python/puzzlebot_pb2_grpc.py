...
class PuzzlebotOdometryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetImage = channel.unary_unary(
                '/RPCDemoPkg.PuzzlebotOdometry/GetImage',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=puzzlebot__pb2.ImageFloat.FromString,
                )
...
def add_PuzzlebotOdometryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetImage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetImage,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=puzzlebot__pb2.ImageFloat.SerializeToString,
            ),
    }
...
class PuzzlebotOdometry(object):
    ...
    def GetImage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/RPCDemoPkg.PuzzlebotOdometry/GetImage',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            puzzlebot__pb2.ImageFloat.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
