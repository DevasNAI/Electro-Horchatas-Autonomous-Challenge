...
class Bug2Controller:
    def __init__(self):
        ...
        self.goal.pose.position.x = 1.5
        self.goal.pose.position.y = 2
	...
	#print("Past Distance: ", self.past_front_distance)
	#print("Current Distance: ", self.front_distance)
        #print("Future Distance: ", self.future_distance)
        self.frontL_distance = np.min(data[91:180])
	#print("Ranges: ", len(msg.ranges))
	#print("Left Distance: ", self.frontL_distance)
    ...
    def run(self):
        ...
        while True:
            ...
            if goal_distance < 0.1 and self.current_state != StateMachine.STOP:  # Stop if the goal is reached
